...
const ortFiles = readdirSync(ortDist).filter((f) => /^ort-wasm-.*\.(mjs|wasm)$/.test(f));
...
console.log(`[copy-ort] Copied ${ortFiles.length} ORT runtime files (.mjs + .wasm) to public/ort/`);
